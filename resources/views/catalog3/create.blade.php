...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">{{isset($catalog_item3s) ? 'Editar Artículo' : 'Añadir Artículo'}}</h1>
  ...
  <div class="row justify-content-center">
    ...
    <div class="card mt-3 col-md-8 mb-5">
        <div class="card-body">
          @if(isset($catalog_item3s))
          <form method="POST" id="formulario" action="{{route('catalog3.update', $catalog_item3s->id)}}" enctype="multipart/form-data">
            @csrf

              <div class="form-group">
                <label for="title" class="col-form-label">Titulo</label>
                <input id="title" type="input" name="title" class="form-control @error('title') is-invalid @enderror"  value="{{isset($catalog_item3s) ? $catalog_item3s->title : ''}}">
                  @error('title')
              ...
              <div class="form-group">
                ...
                <input id="img_btn" type="input" name="img_btn" class="form-control @error('img_btn') is-invalid @enderror"  value="{{isset($catalog_item3s) ? $catalog_item3s->img_btn : ''}}">
                  @error('img_btn')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input id="icon" type="text" data-placement="bottomRight" class="form-control @error('img_icon') is-invalid @enderror"  name="img_icon" value="{{isset($catalog_item3s) ? $catalog_item3s->img_icon : ''}}">
                  <div class="btn-group">
                     <button type="button" class="btn btn-primary iconpicker-component"><i
                             class="{{ isset($catalog_item3s) ? $catalog_item3s->img_icon : 'fab fa-font-awesome-alt' }}"></i></button>
              ...
              <div class="form-group">
                ...
                <input id="precio" type="input" name="precio" class="form-control @error('precio') is-invalid @enderror" placeholder="$" value="{{ $catalog_item3s->precio }}">
                  @error('button')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group">
                ...
                <div class="form-group" id="d-titulo">
                  ...
                  <input id="destacado_title" placeholder="%50 de Descuento" type="input" name="destacado_title" class="form-control @error('destacado_title') is-invalid @enderror"  value="{{isset($catalog_item3s) ? $catalog_item3s->destacado_title : ''}}">
                ...
                <div class="form-group" id="d-precio">
                  ...
                  <input id="precio_nuevo" placeholder="$" type="input" name="precio_nuevo" class="form-control @error('precio_nuevo') is-invalid @enderror"  value="{{isset($catalog_item3s) ? $catalog_item3s->precio_nuevo : ''}}">
                  @error('precio_nuevo')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group" id="d-precio">
                ...
                <input id="button" type="input" name="button" class="form-control @error('button') is-invalid @enderror"  value="{{isset($catalog_item3s) ? $catalog_item3s->button : ''}}">
                @error('button')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input id="icon2" type="text" data-placement="bottomRight" class="form-control @error('button_icon') is-invalid @enderror"  name="button_icon" value="{{isset($catalog_item3s) ? $catalog_item3s->button_icon : ''}}">
                  <div class="btn-group">
                     <button type="button" class="btn btn-primary iconpicker-component"><i class="{{ isset($catalog_item3s) ? $catalog_item3s->button_icon : 'fab fa-font-awesome-alt' }}"></i></button>
              ...
              <div class="form-group" id="d-precio">
                ...
                <input id="button_link" type="input" name="button_link" class="form-control @error('button_link') is-invalid @enderror"  value="{{isset($catalog_item3s) ? $catalog_item3s->button_link : ''}}">
                @error('button_link')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
...
<!-- /OTRAS IMAGENES -->
          ...
          @else
          <form method="POST" id="form" action="{{route('catalog3.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
              <label for="title" class="col-form-label">Titulo</label>
              <input id="title" type="input" name="title" class="form-control @error('title') is-invalid @enderror"  value="{{isset($catalog_item3s) ? $catalog_item3s->title : ''}}">
      ...
      <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
              ...
              <form id="image" method="POST" class="image dropzone" action="{{ route('catalog3.update', $catalog_item3s->id) }}" enctype="multipart/form-data">
                @csrf
              </form>
              @error('image')
                <span class="invalid-feedback" role="alert">
            ...
            <div class="col-md-8">
              @if(isset($catalog_item3s))
              <img style="width:100%;" src="{{'/storage/' . $catalog_item3s->img_primaria}}" class="logoThumb img-fluid img-thumbnail rounded">
              @endif
      ...
      <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
              <label for="logo" class="col-form-label">Imagen</label>
              <form id="image2" method="POST" class="image2 dropzone" action="{{route('catalog3.update', $catalog_item3s->id)}}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="col-md-8">
              @if(isset($catalog_item3s))
              <img style="width:100%;" src="{{'/storage/' . $catalog_item3s->img_secundaria}}" class="logoThumb2 img-fluid img-thumbnail rounded">
              @endif
...
$('#clearImage').on('click', function() {
  ...
  $.ajax({
         type:'POST',
         dataType: 'json',
         url:'{{route("sec.img.destroy", $catalog_item3s->id)}}',
...
OnCallback: function(val) {
  ...
  $.ajax({
         type:'POST',
         dataType: 'json',
         url:'/catalog3Update/{{$catalog_item3s->id}}',
         data:{"_token": "{{ csrf_token() }}",
         val:val
        },
         success:function(data){
