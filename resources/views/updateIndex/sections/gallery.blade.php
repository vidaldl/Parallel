<!-- Gallery -->
  <div class="col-md-12 mb-4">
    ...
    <div class="card shadow mb-4">
      <a href="#" style="text-decoration: none" data-toggle="collapse" data-target="#gallery10" aria-expanded="true" aria-controls="gallery10">
        <div class="card-header py-3">
        <form method="POST" action="{{route('galleries.display')}}">
          ...
          <div class="row">
            ...
            <span class="col-md-5"><h6 class="m-0 font-weight-bold text-primary">Seccion de Galería</h6></span>
      ...
      <div id="gallery10" class="collapse">
        <div class="card-body row">
        <div class="col-md-6">
