<!-- Info Slider 2 -->
  <div class="col-md-12 mb-4">
    ...
    @foreach($orders as $item)
      @if($item->id == 3)
    <form method="POST" action="{{route('line.update', 3)}}">
      @csrf
      <div class="line-space card col-md-8 offset-md-2 mt-4 mb-4">
        <a href="#" style="text-decoration: none" data-toggle="collapse" data-target="#collapse3" aria-expanded="true" aria-controls="collapse3">
    ...
    <div class="card shadow mb-4">
      <a href="#" style="text-decoration: none" data-toggle="collapse" data-target="#infoslider2_3" aria-expanded="true" aria-controls="infoslider2_3">
        <div class="card-header py-3">
        <form method="POST" action="{{route('infoSlider2.display', $info_slider_text2s[0]->id)}}">
          ...
          <div class="row">
            ...
            <span class="col-md-5"><h6 class="m-0 font-weight-bold text-primary">Slider de Informacion 2</h6></span>
              <select onchange="this.form.submit()" name="infoslider2" class="col-md-6  float-right">
                @foreach($orders as $order)
                @if($order->section == 'infoslider2' && $order->display == 1)
                <option selected value="1">Mostrar</option>
                <option value="0">Esconder</option>
                @elseif($order->section == 'infoslider2' && $order->display == 0)
      ...
      <div id="infoslider2_3" class="collapse">
        <div class="card-body row">
        <div class="col-md-6">
