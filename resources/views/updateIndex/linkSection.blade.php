...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Sección de Enlaces</h1>
  ...
  <div class="row justify-content-center">
    ...
    <div class="card mt-3 col-md-8 mb-5">
        <div class="card-body">
          ...
          <form method="POST" action="{{route('link.update', $link_sections[0]->id)}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group">
                ...
                <input id="title" type="input" name="title" class="form-control @error('title') is-invalid @enderror"  value="{{ $link_sections[0]->title }}">
                  @error('title')
              ...
              <div class="form-group">
                ...
                <input onchange="this.form.submit()" class="form-control col-md-6"  name="back_color" type="text" id="back_color" value="{{ $link_sections[0]->back_color }}">
              </div>
              <div class="form-group">
                <a class="btn btn-primary float-left" href="{{ route('links.index') }}"><i class="fas fa-newspaper"></i> &nbsp; Editar Enlaces</a>
