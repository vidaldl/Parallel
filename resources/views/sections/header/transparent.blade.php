...
@else
<header id="header" class="transparent-header full-header no-sticky" data-sticky-class="dark">
@endif
  <div id="header-wrap">
    <div class="container-fluid clearfix" style="padding-left: {{$menu_item[0]->padding}}px; padding-right: {{$menu_item[0]->padding}}px;">
      ...
      <div id="logo" {{$menu_item[0]->menu_borders == 0 ? 'style=border:none' : ''}}>
        <a href="/" class="standard-logo" data-dark-logo="{{'/storage/' . $menu_item[0]->logo_dark}}"><img src="{{'/storage/' . $menu_item[0]->logo}}"></a>
        <a href="/" class="retina-logo" data-dark-logo="{{'/storage/' . $menu_item[0]->logo_dark}}"><img src="{{'/storage/' . $menu_item[0]->logo}}" alt="Logo"></a>
      </div>
      <!-- Primary Navigation
      ============================================= -->
        ...
        @if($styles[0]->show_link_1 == '1')
          @if($styles[0]->link_mode_1 == '1')
            <li data-toggle="tooltip" data-placement="bottom" title="{{$styles[0]->custom_link_text_1}}">
              <a style="font-family: {{$fonts[1]->font_name}}" href="{!! $styles[0]->custom_link_address_1 !!}"><i style="font-size: 25px!important;" class="{{$styles[0]->custom_icon_1}} fa-2x"></i></a>
            </li>
        ...
        @if($styles[0]->show_link_2 == '1')
          @if($styles[0]->link_mode_2 == '1')
            <li data-toggle="tooltip" data-placement="bottom" title="{{$styles[0]->custom_link_text_2}}">
              <a style="font-family: {{$fonts[1]->font_name}}; " href="{!! $styles[0]->custom_link_address_2 !!}"><i style="font-size: 25px!important;" class="{{$styles[0]->custom_icon_2}}"></i></a>
            </li>
