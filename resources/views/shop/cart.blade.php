            ...
            <tr class="cart_item">
              ...
              <td class="cart-product-thumbnail">
                @foreach($shop_items as $it)
                  @if($it->id == $item->id)
                  <a href="#"><img src="{{'/storage/' . $it->img_primaria}}" alt="Pink Printed Dress"></a>
                  @endif
                @endforeach
              </td>
              ...
              <td colspan="6">
                <div class="row clearfix">
                  ...
                  <div class="col-lg-8 col-8 nopadding">
                    <a href="#" class="buttonesse button-3d nomargin fright">Update Cart</a>
                    <a href="shop.html" class="buttonesse button-3d notopmargin fright">Proceed to Checkout</a>
                  </div>
                </div>
              </td>
            </tr>
            ...
            <table class="table cart">
              <tbody>
                ...
                <tr class="cart_item">
                  ...
                  <td class="cart-product-name">
                    <span class="amount colore lead"><strong>$106.94</strong></span>
                  </td>
                </tr>
              </tbody>
