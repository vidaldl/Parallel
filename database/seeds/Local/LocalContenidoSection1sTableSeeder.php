...
class LocalContenidoSection1sTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('contenido_section1s')->insert(array (
            ...
            array (
                ...
                'background_image' => 'content/nbe5fKw65OMb5Sv7rgwBf5U0pbLmdeZhUb0U41dW.png',
                'title' => 'ASEA Rep. Dom.',
                'tagline' => '- Tecnología de Señalización Redox -Tribu Kayi',
                'button' => NULL,
                'link' => '#infoSlider',
                'display' => '0',
                'carousel' => '0',
