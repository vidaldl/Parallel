...
class ContenidoSection1sTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('contenido_section1s')->insert(array (
            ...
            array (
                'id' => 1,
                'logo' => 'content/WuXs0HsWykTORaQNsbVYsK6fhUP8KGJtrpNV43Pj.png',
                'background_image' => 'content/EmnTSuaR24KnmueUTKzl6gzg6PRf1R5Mv3Qf1xbi.png',
                'title' => 'Madre Tierra',
                'tagline' => '<p>Desde la Tierra Hasta Tí</p>',
                'button' => 'Conoce Más',
                'link' => '#infoSlider',
                'display' => 1,
                'carousel' => NULL,
