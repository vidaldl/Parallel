    ...
    public function run()
    {
        ...
        \DB::table('contenido_section1s')->insert(array (
            ...
            array (
                ...
                'tagline' => '<p>1. Slogan una frase muy especial que agarre ala gente</p><p>2. Enterate de nosotros</p><p>3. No bulto mi hermano</p>',
                'button' => 'Hola',
                'link' => '#infoSlider',
                'display' => 0,
                'carousel' => 1,
            ...
            array (
                ...
                'tagline' => '<p>hello is it me you\'re looking for?kk</p>',
                'button' => 'asdasdasd',
                'link' => '#contact',
                'display' => 0,
                'carousel' => 1,
