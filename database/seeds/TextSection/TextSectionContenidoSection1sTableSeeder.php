...
class TextSectionContenidoSection1sTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('contenido_section1s')->insert(array (
            ...
            array (
                'id' => '1',
                'logo' => 'content/AV1DSx8FpPGWUlcF8NnDSxkw6uuNhcmftQbWH3hd.png',
                'background_image' => 'content/HBXtsWSOHJAsogLtFdbCiDSno0F62oXWge5rAV7Y.png',
                'title' => NULL,
                'tagline' => 'Caribbean Equipment Medical es la empresa dedicada al sector médico dentro de nuestro grupo, que también se dedica al sector de la construcción y la agricultura, llevando a cabo nuestros proyectos durante los últimos 35 años con éxito en América Latina, el Caribe y los Estados Unidos.',
                'button' => 'Contáctanos',
                'link' => '#contact',
                'display' => '1',
                'carousel' => '0',
