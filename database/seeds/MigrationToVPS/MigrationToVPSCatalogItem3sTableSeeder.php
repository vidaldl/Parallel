...
class MigrationToVPSCatalogItem3sTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('catalog_item3s')->insert(array (
            ...
            array (
                'id' => 5,
                'title' => 'Pantalon',
                'img_primaria' => 'content/catalog/aJcpvTAheBFbdFIHZ6tYsH3RzyeJMyj2sHyX7UPL.png',
                'img_secundaria' => 'content/catalog/uNlN1lN9V747T0K9Jl04B1dVtRZyJiBcF4XaAm9d.png',
                'img_btn' => 'Acercar',
                'img_icon' => 'fas fa-search-plus',
                'precio' => NULL,
                'destacado' => 0,
